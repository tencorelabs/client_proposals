...
## 5) Optional Add-On: BLE Protocol Design & Hardware Integration
...
## 6) Implementation Plan (4 Phases) + Payment Plan

Total target budget: **₹45,00,000** (₹45 lakh), split into 4 phases to reduce cash-flow pressure.

*Note: If BLE Protocol Design add-on is selected, Phase 1 becomes ₹10,00,000 (₹6L app + ₹4L protocol).*

### Phase 1 – Discovery & Prototype (4–6 weeks)  
**Budget:** ₹6,00,000 (or ₹10,00,000 with BLE Protocol add-on)
...
- **40% on kickoff** – ₹2,40,000 (or ₹4,00,000 with add-on)  
- **40% on delivery of working prototype** (app + firmware demo) – ₹2,40,000 (or ₹4,00,000 with add-on)  
- **20% on completion of pilot feedback report & go/no-go decision** – ₹1,20,000 (or ₹2,00,000 with add-on)  
...
## 7) Investment Summary & Cash Flow View

### Scenario 1: App Only (Hardware Team Provides Protocol)

| Phase | Description | Cost |
|-------|-------------|------|
| Phase 1 | Discovery & Prototype | ₹6,00,000 |
| Phase 2 | MVP Core | ₹12,00,000 |
| Phase 3 | Commercial Readiness | ₹15,00,000 |
| Phase 4 | Scale & Enhancements | ₹12,00,000 |
| **Total** | **Complete app (4 phases)** | **₹45,00,000** |

### Scenario 2: Full Solution (Including BLE Protocol Design)

| Phase | Description | Cost |
|-------|-------------|------|
| Phase 0 | BLE Protocol Design | ₹4,00,000 |
| Phase 1 | Discovery & Prototype | ₹6,00,000 |
| Phase 2 | MVP Core | ₹12,00,000 |
| Phase 3 | Commercial Readiness | ₹15,00,000 |
| Phase 4 | Scale & Enhancements | ₹12,00,000 |
| **Total** | **Full solution (protocol + app)** | **₹49,00,000** |

**Cash flow over time (Scenario 2 example):**

- **Month 0–1 (Phase 0):** ₹4,00,000 (BLE protocol)  
- **Month 1–2.5 (Phase 1):** ₹6,00,000  
- **Month 2.5–5 (Phase 2):** ₹12,00,000  
...
- **If hardware team needs BLE protocol help:**  
  → Add **BLE Protocol Design** (₹4L) to any of the above models.

You can present all three options and let them choose the one that feels most comfortable.

---

## 10) Why This Makes Sense Now
...
**Ask:** Approve **Phase 1 (₹6L or ₹10L with BLE protocol)** with the payment plan above to build a working prototype and validate demand with real customers. Based on pilot feedback, decide on Phase 2 rollout under one of the three deal structures (fixed-fee, royalty, or joint product).
